...
function constructPosterInfo(post: Status, isRepliedTo = false) {
...
function constructInteractionRow(post: Status) {
	function constructInteractionItem(icon: string, className: string, spinny?: boolean, text?: string) {
...
function formatInEmojis(string: string, emojis: any) {
